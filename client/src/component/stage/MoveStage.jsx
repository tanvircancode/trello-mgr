...
const MoveStage = ({ showRect }) => {
    ...
    const [selectedProjectFromOption, setSelectedProjectFromOption] = useState(null);
    ...
    const handleProjectSelection = (e) => {
        setSelectedProjectFromOption(e.target.value);
    ...
    }, [showRect, selectedProjectFromOption]);
        ...
        >  
            ...
            >
                {projects.map((project) => {
                    return (    
                        <option selected={selectedProject.id == project.id } key={project.id} value={project.id} >
                            {project.title} {selectedProject.id == project.id && <span>(current)</span>}
                        </option>  
                    )
                })}
